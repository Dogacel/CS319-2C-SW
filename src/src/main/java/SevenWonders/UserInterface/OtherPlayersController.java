                    ...
                    if (player.getWonder().getCurrentStageIndex() >= 3) {
                        ...
                        if (player.getId() == gameplayController.gameModel.getRightPlayer(gameplayController.client.getID()).getId()) {
                            ...
                            for (int i = 0; i < gameplayController.gameModel.getLeftPlayer(gameplayController.client.getID()).getLostWarNumber(); i++) {
                                minusOnes.getChildren().add(new ImageView(AssetManager.getInstance().getImage("warpoint_minus1.png")));
                            }
                            outerPane.setManaged(false);
                            minusOnes.setVisible(true);
                            outerPane.setLayoutY(5);
                            ...
                            outerPane.setMaxHeight(50);
                            outerPane.setVisible(true);
                            for (int i = 0; i < gameplayController.gameModel.getRightPlayer(gameplayController.client.getID()).getLostWarNumber(); i++) {
                                minusOnes.getChildren().add(new ImageView(AssetManager.getInstance().getImage("warpoint_minus1.png")));
                            }
                            outerPane.setManaged(false);
                            minusOnes.setVisible(true);
                            outerPane.setLayoutY(5);
                            outerPane.setLayoutX(1280 - 213.3);
                            outerPane.getChildren().add(minusOnes);
                        } else {
